                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="text-center">
                                <h2 class="text-white-50 mx-auto mt-2 mb-5">Kunjungi Tempat Terindah Di Pulau Seram, Tepatnya pulau seram bagian barat.</h2>
                            </div>
                        </div>
...
$sql = "SELECT * FROM skot_wisata ORDER BY id DESC";
...
<div class="container mt-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h4 class="text-center">Daftar Wisata SBB</h4>
            <p class="text-center text-muted">Menampilkan <?php echo count($data); ?> Jumlah Tempat Wisata</p>
        </div>
    </div>
