...
$sql = "SELECT * FROM skot_wisata WHERE status = 'Gunung' ORDER BY id DESC";
        ...
        <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                <div class="text-center">
                    ...
                    <h2 class="text-white-100 mx-auto btn btn-primary">Kunjungi Gunung</h2>
                    <!-- Tambahkan deskripsi atau informasi tambahan -->
                    <p class="text-white mt-2">Temukan keindahan Gunung SBB yang menakjubkan</p>
                </div>
            </div>
        </div>
    </header>
...
<div class="container mt-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h4 class="text-center">Daftar Wisata Gunung</h4>
            <p class="text-center text-muted">Menampilkan <?php echo count($data); ?> Gunung</p>
        </div>
    </div>
        ...
        <?php if (!empty($data)) {
            ...
            <div class="col-12">
                <div class="alert alert-info text-center">
                    <h5><i class="fas fa-umbrella-beach"></i> Belum Ada Data Gunung</h5>
                    <p>Silakan tambahkan data wisata Gunung terlebih dahulu.</p>
                </div>
            </div>
        <?php } ?>
    </div>
